class Properties:
    ...
    Tmax = 100000.0 # maximum temperature
    ...
    sigma = 0.01 # gaussian sigma
    decimal_points = 3 # float decimal points rounding used in program
    draw_graph = False
    Kmax = 5 # K-max iterations in metropolis alg.
